...
`scans <https://localhost:8834/api#/resources/scans>`_ API endpoints.
...
class ScansAPI(NessusEndpoint):
    ...
    def attachment(self, scan_id, attachment_id, key, fobj=None):
        ...
        `scans: attachments <https://localhost:8834/api#/resources/scans/attachments>`_
        ...
        Examples:
            ...
            ...     nessus.scans.attachement(1, 1, 'abc', fobj)
        '''
        if not fobj:
    ...
    def configure(self, id, **kw):
        ...
        `scans: configure <https://localhost:8834/api#/resources/scans/configure>`_
        ...
        Examples:
            >>> nessus.scans.configure(1, name='New Scan Name')
        '''
    ...
    def copy(self, scan_id, folder_id=None, name=None):
        ...
        `scans: copy <https://localhost:8834/api#/resources/scans/copy>`_
        ...
        Examples:
            >>> new_scan = nessus.scans.copy(1, 'New Scan Name')
        '''
    ...
    def create(self, **kw):
        ...
        `scans: create <https://localhost:8834/api#/resources/scans/create>`_
        ...
        Examples:
            ...
            >>> scan = nessus.scans.create(targets=['127.0.0.1'])
        '''
    ...
    def delete(self, *scan_ids):
        ...
        `scans: delete <https://localhost:8834/api#/resources/scans/delete>`_
        ...
        Examples:
            ...
            >>> nessus.scans.delete(1,2,3)
        '''
        if(len(scan_ids) == 1):
            self._api.delete('scans/{}'.format(self._check('scan_id', scan_ids[0], int)))
        else:
            self._api.delete('scans',
                json={'ids': [self._check('scan_id', i, int) for i in scan_ids]})

    def delete_history(self, scan_id, history_id):
        '''
        Remove an instance of a scan from a scan history.

        `scans: delete-history <https://localhost:8834/api#/resources/scans/delete-history>`_
    ...
    def results(self, scan_id, history_id=None):
        ...
        `scans: details <https://localhost:8834/api#/resources/scans/details>`_
        ...
        Examples:
            ...
            >>> results = nessus.scans.results(1)

            Retrieve a specific instance of the result set:

            >>> results = nessus.scans.results(1, 1)
        '''
        params = dict()
        if history_id:
    ...
    def export(self, scan_id, *filters, **kw):
        ...
        `scans: export <https://localhost:8834/api#/resources/scans/export-request>`_
        ...
        Examples:
            ...
            ...     nessus.scans.export(1, fobj=reportobj)

            Export a specific instance of the scan:

            >>> with open('example.nessus', 'wb') as reportobj:
            ...     nessus.scans.export(1, history_id=1, fobj=reportobj)
        '''
    ...
    def host_details(self, scan_id, host_id, history_id=None):
        ...
        `scans: host-details <https://localhost:8834/api#/resources/scans/host-details>`_
        ...
        Examples:
            >>> host = nessus.scans.host_details(1, 1)
        '''
        params = dict()
        if history_id:
            params['history_id'] = self._check('history_id', history_id, int)
    ...
    def import_scan(self, fobj, folder_id=None, password=None):
        ...
        `scans: import <https://localhost:8834/api#/resources/scans/import>`_
        ...
        Examples:
            ...
            ...     nessus.scans.import(reportobj)

            Import a NessusDB report.

            >>> with open('example.db') as reportobj:
            ...     nessus.scans.import(reportobj, password='sekret')
        '''
    ...
    def launch(self, scan_id, targets=None):
        ...
        `scans: launch <https://localhost:8834/api#/resources/scans/launch>`_
        ...
        Examples:
            ...
            >>> nessus.scans.launch(1)

            Launch the scan with some custom targets:

            >>> nessus.scans.launch(1, targets=['127.0.0.1'])
        '''
        payload = dict()
        if targets:
    ...
    def list(self, folder_id=None, last_modified=None):
        ...
        `scans: list <https://localhost:8834/api#/resources/scans/list>`_
    ...
    def pause(self, scan_id, block=False):
        ...
        `scans: pause <https://localhost:8834/api#/resources/scans/pause>`_
    ...
    def plugin_output(self, scan_id, host_id, plugin_id, history_id=None):
        ...
        `scans: plugin-output <https://localhost:8834/api#/resources/scans/plugin-output>`_
        ...
        Examples:
            >>> output = nessus.scans.plugin_output(1, 1, 1)
            >>> pprint(output)
        '''
        params = dict()
        if history_id:
    ...
    def set_read_status(self, scan_id, read_status):
        ...
        `scans: read-status <https://localhost:8834/api#/resources/scans/read-status>`_
        ...
        Examples:
            ...
            >>> nessus.scans.set_read_status(1, False)
        '''
    ...
    def resume(self, scan_id):
        ...
        `scans: resume <https://localhost:8834/api#/resources/scans/resume>`_
    ...
    def schedule(self, scan_id, enabled):
        ...
        `scans: schedule <https://localhost:8834/api#/resources/scans/schedule>`_
    ...
    def stop(self, scan_id, block=False):
        ...
        `scans: stop <https://localhost:8834/api#/resources/scans/stop>`_
    ...
    def timezones(self):
        ...
        `scans: timezones <https://localhost:8834/api#/resources/scans/timezones>`_

        Returns:
            list: List of allowed timezone strings accepted by Tenable.IO

        Examples:
            >>> for item in nessus.scans.timezones():
            ...     pprint(item)
        '''
